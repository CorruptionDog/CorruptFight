...
public class CorruptCollider {
    ...
    public static final Collider DAWN = new OBBCollider(2.5D, 0.6D, 2.0D, 0.0D, 0.5D, -1.75D);
    public static final Collider RISING_STAR = new MultiOBBCollider(3, 0.2D, 0.8D, 2.5D, 0.0D, 0.0D, -0.5D);

    public static final Collider RISING_STAR_SECOND = new OBBCollider(3.0D, 0.4D, 2.0D, 0.0D, 1.2D, -1.0D);
