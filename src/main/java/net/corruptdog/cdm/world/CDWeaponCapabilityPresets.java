...
public class CDWeaponCapabilityPresets {
    ...
    public static final Function<Item, CapabilityItem.Builder> KATANA = (item) ->
            WeaponCapability.builder()
                    ...
                    .livingMotionModifier(Styles.TWO_HAND, LivingMotions.JUMP, CorruptAnimations.BIPED_HOLD_KATANA)
                    ...
                    .livingMotionModifier(Styles.TWO_HAND, LivingMotions.SNEAK, CorruptAnimations.WALK_KATANA)
                    .livingMotionModifier(Styles.TWO_HAND, LivingMotions.SWIM, CorruptAnimations.BIPED_HOLD_KATANA)
                    .livingMotionModifier(Styles.TWO_HAND, LivingMotions.FLOAT, CorruptAnimations.BIPED_HOLD_KATANA)
                    ...
                    .livingMotionModifier(Styles.SHEATH, LivingMotions.FLOAT, CorruptAnimations.BIPED_HOLD_KATANA_SHEATHING)
    ...
    public static final Function<Item, CapabilityItem.Builder> YAMATO = item ->
            WeaponCapability.builder()
                    ...
                    .newStyleCombo(Styles.TWO_HAND, CorruptAnimations.YAMATO_AUTO1, CorruptAnimations.YAMATO_AUTO2,CorruptAnimations.YAMATO_AUTO3,CorruptAnimations.YAMATO_AUTO4,CorruptAnimations.YAMATO_DASH,CorruptAnimations.YAMATO_AIRSLASH)
                    ...
                    .livingMotionModifier(Styles.TWO_HAND, LivingMotions.FLOAT, CorruptAnimations.YAMATO_IDLE)
                    .livingMotionModifier(Styles.TWO_HAND, LivingMotions.FALL, CorruptAnimations.YAMATO_IDLE)
